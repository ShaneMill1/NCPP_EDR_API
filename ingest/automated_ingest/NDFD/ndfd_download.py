...
precision_mapping={
 'maxt':{'astype':int}, 
 'mint':{'astype':int},
 'temp':{'astype':float,'prec':1},
 'dew':{'astype':float,'prec':1},
 'appt':{'astype':float,'prec':1},
 'pop12':{'astype':int},
 'qpf':{'astype':float,'prec':2},
 'snow':{'astype':float,'prec':2},
 'sky':{'astype':int},
 'rh':{'astype':float,'prec':1},
 'wspd':{'astype':float,'prec':1},
 'wdir':{'astype':int},
 'waveh':{'astype':float,'prec':1},
 'incw34':{'astype':int},
 'incw50':{'astype':int},
 'incw64':{'astype':int},
 'cumw34':{'astype':int},
 'cumw50':{'astype':int},
 'cumw64':{'astype':int},
 'wgust':{'astype':float,'prec':1},
 'critfireo':{'astype':int},
 'dryfireo':{'astype':int},
 'conhazo':{'astype':int},
 'ptornado':{'astype':int},
 'phail':{'astype':int},
 'ptstmwinds':{'astype':int},
 'pxtornado':{'astype':int},
 'pxhail':{'astype':int},
 'pxtstmwinds':{'astype':int},
 'ptotsvrtstm':{'astype':int},
 'pxtotsvrtstm':{'astype':int},
 'tmpabv14d':{'astype':int},
 'tmpblw14d':{'astype':int},
 'tmpabv30d':{'astype':int},
 'tmpblw30d':{'astype':int},
 'tmpabv90d':{'astype':int},
 'tmpblw90d':{'astype':int},
 'prcpabv14d':{'astype':int},
 'prcpblw14d':{'astype':int},
 'prcpabv30d':{'astype':int},
 'prcpblw30d':{'astype':int},
 'prcpabv90d':{'astype':int},
 'prcpblw90d':{'astype':int},
 'precipa_r': {'astype':float,'prec':2},
 'sky_r':{'astype':int},
 'td_r':{'astype':float,'prec':1},
 'temp_r':{'astype':float,'prec':1},
 'wdir_r':{'astype':int},
 'wspd_r':{'astype':float,'prec':1},
 'iceaccum':{'astype':float,'prec':2},
 'maxrh':{'astype':int},
 'minrh':{'astype':int},
 'evp24':{'astype':float,'prec':2},
 'evpdep24':{'astype':float,'prec':2},
 'evp168':{'astype':float,'prec':2},
 'tcsurge':{'astype':int},
 'tcrain':{'astype':int},
 'tcwind':{'astype':int},
 'tctornado':{'astype':int},
 'ppi':{'astype':int},
 'probtsrwe24':{'astype':int},
 'snowlvl':{'astype':int},
 'snow24e10':{'astype':int},
 'snow24e90':{'astype':int},
 'snow48e10':{'astype':int},
 'snow48e90':{'astype':int},
 'snow72e10':{'astype':int},
 'snow72e90':{'astype':int},
 'wbgt':{'astype':float,'prec':1},
 'utemp':{'astype':float,'prec':1},
 'utd':{'astype':float,'prec':1},
 'uwspd':{'astype':float,'prec':1},
 'uwdir':{'astype':int},
}
...
def convert_to_zarr(folderdate):
   ...
   for instance in glob.glob(LOCAL_DOWNLOAD_FOLDER+'/ndfd'+'/*'):
      for region in glob.glob(instance+'/*'):
         ...
         for time_range in time_file_list:
            ...
            if len(files_to_grab)>0:
               ...
               for dv in ds.data_vars:
                  if dv != 'wx' and dv != 'wwa':
                     dataarray=ds[dv]
                     dtype=precision_mapping[dv]['astype']
                     if dtype == int:
                        dataarray=dataarray.astype(dtype)
                     if dtype == float:
                        prec=int(precision_mapping[dv]['prec'])
                        dataarray=dataarray.astype(np.float64)
                        da_values=np.around(dataarray.values.astype(np.float64),decimals=prec)
                        dataarray.values=da_values
                     dataset=dataarray.to_dataset()
                     if 'lat_0' in ds.dims:
                        dataset=dataset.assign_coords({'lat_0':dataset.lat_0})
                        dataset=dataset.assign_coords({'lon_0':dataset.lon_0})
                        chunks={'lat_0':128,'lon_0':128}
                        dataset=dataset.chunk(chunks)
                     if 'xgrid_0' in ds.dims:
                        dataset=dataset.assign_coords({'xgrid_0':dataset.xgrid_0})
                        dataset=dataset.assign_coords({'ygrid_0':dataset.ygrid_0})
                        chunks={'xgrid_0':128,'ygrid_0':128}
                        dataset=dataset.chunk(chunks)
                     try:
                         append_coord='forecast_time0_'+dv
                         if os.path.isdir(zarr_folder_temp)==True:
                            #try to append to existing coordinate, else merge in with new coord
                            try:
                               dataset.to_zarr(zarr_folder_temp,mode='a',compute=True,consolidated=True,append_dim=append_coord)
                            except:
...
def set_dims(ds):
      ...
      if wx_param_name != 'wx' and wx_param_name != 'wwa':
         dtype=precision_mapping[wx_param_name]['astype']
