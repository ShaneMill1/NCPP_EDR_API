...
import EDR.provider.xmlConfig as des
import EDR.provider.xmlUtilities as deu
import sys
...
class Encoder:
    ...
    def preamble(self):
        ...
        if 'UNKNOWN' not in self.decodedTAC['region']:
            ...
            child.set('nilReason', des.NIL_UNKNWN_URL)
        ...
        if self.decodedTAC['summit']['elevation'].isdigit():
            ...
            child.set('nilReason', des.NIL_NA_URL)
        else:
            child.set('nilReason', des.NIL_UNKNWN_URL)
    ...
    def volcano(self, parent):
        ...
        if 'UNKNOWN' in self.decodedTAC['volcanoLocation']:
            indent2.set('nilReason', des.NIL_UNKNWN_URL)
        else:
    ...
    def postContent(self):
        ...
        try:
            ...
            indent.set('nilReason', des.NIL_NA_URL)
